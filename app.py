...
DEFAULT_CONFIG = {
    "site_title": "FUHX FF PREMIUM HOSTING WEB",
    "site_header": "FuhX PREMIUM VPS",
...
async def api_check(message: types.Message):
    ...
    try:
        ...
        r = requests.get(url, timeout=15, headers={
            'User-Agent': 'Mozilla/5.0 (FUHX VPS Bot)'
        })
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("FUHX PREMIUM VPS - Starting...")
    print("=" * 50)
    print(f"Port: {port}")
    print(f"Debug: {debug}")
    ...
    print("  Secret: FXFUHXFFKING (Can change user password)")
